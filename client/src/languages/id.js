export default {
  ...
  app_login_sign_in_go_to_register: 'Belum punya akun?',

  app_sign_up_title: 'Daftar',
  app_sign_up_email_title: 'Email',
  app_sign_up_first_name: 'Nama Depan',
  app_sign_up_last_name: 'Nama Belakang',
  app_sign_up_password_title: 'Kata Sandi',
  app_sign_up_confirm_password_title: 'Konfirmasi Kata Sandi',
  app_sign_up_or_text: 'Atau',
  app_sign_up_birtday: 'Tanggal Lahir',
  app_sign_up_with_google_text: 'Masuk dengan Google',
  app_sign_up_text_to_login: 'Sudah memiliki akun?',
  app_sign_up_button_next_text: 'Selanjutnya',
  ...
  app_component_empty_video_title: 'Buat konten di perangkat apa pun',
  app_component_empty_video_message:
    'Upload dan rekam konten di rumah atau kapan saja di mana saja. Semua video publik Anda akan muncul di sini.',

  app_premium_head_title: 'Pilih langganan yang sesuai dengan Anda',
  app_premium_premim_title: 'HahTube Music & HahTube bebas iklan',
  app_premium_premim_title_checkout: 'Selesaikan pembelian Anda',
  app_premium_premim_select_payment_first: 'Silahkan pilih metode pembayaran!',
  app_premium_premim_title_button_buy_in_card_packet: 'Beli',

  app_post_video_title: 'Posting Video Anda',
  app_post_video_title_form: 'Judul *',
  app_post_video_thumbnail_form: 'Thumbnail *',
  app_post_video_description_form: 'Deskripsi',
  app_post_video_video_form: 'Video *',
  app_post_video_kids_form: 'Untuk Anak',
  app_post_video_category_form: 'Kategori',
  app_post_video_visibility_form: 'Dapat Dilihat',
  app_post_video_button_form: 'Posting',

  app_add_category_title: 'Buat Kategori',
  app_add_category_title_form: 'Nama',
  app_add_category_button_form: 'Buat',
};
